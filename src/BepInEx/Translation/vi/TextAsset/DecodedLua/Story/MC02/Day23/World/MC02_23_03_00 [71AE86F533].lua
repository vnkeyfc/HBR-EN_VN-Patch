...
LinneEvent("MSatsuki",[[We have new and improved boosters, freshly stocked! ♪]],MSatsukiMessage,nil,"Shop")local nsgji=GetWorldEventStep(w0qyLbH)if nsgji==0 then
StartEvent(function()
...
Linne.Receive(bClTIa,[[The price you see is the power you get! ♪]])Linne.Inputing(bClTIa)Linne.Wait(bClTIa,1.0)
