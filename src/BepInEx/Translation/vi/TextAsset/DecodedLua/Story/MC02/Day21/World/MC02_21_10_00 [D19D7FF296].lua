...
InitScript("Lua/Story/Common/Activity/MC02/Activity")NNanaseMessageAboutArena()GayaTalkFromMaster()
GeneralTalkFromMaster()QuestEventFromMaster()
local nsgji=GetWorldEventStep(w0qyLbH)if nsgji==0 then
StartEvent(function()NextWorldEventStep(w0qyLbH,false)
Yield(StartFreeTime)end)end end
