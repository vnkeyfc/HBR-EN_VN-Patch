...
INCLUDE("Lua/Story/Common/Activity/Common/ActivityAtArena")local w0qyLbH="Event"..WorldLabel()
function preload()
...
InitScript("Lua/Story/Common/Activity/MC02/Activity")Field.setActive("ResearchBuildingGate",false)
NNanaseMessageAboutArena()
InitScript("Lua/Story/Common/Activity/Common/ActivityAtArena")GayaTalkFromMaster()GeneralTalkFromMaster()
QuestEventFromMaster()Field.setActiveWithTag("IMinase",false)
Field.setActiveWithTag("SMinase",false)Field.setActiveWithTag("SHiguchi",false)
Field.setActiveWithTag("KHiiragi",false)Field.setActiveWithTag("Byakko",false)
