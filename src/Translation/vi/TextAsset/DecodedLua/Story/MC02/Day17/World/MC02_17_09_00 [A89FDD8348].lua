...
Field.hideTagCharacters("SHanamura")QuestEventFromMaster()
local nsgji=GetWorldEventStep(w0qyLbH)if nsgji==0 then
StartEvent(function()NextWorldEventStep(w0qyLbH,false)
Yield(StartFreeTime)end)end
TouchEvent("ArenaGate",MC02_17_Arena)end
function StartFreeTime()
Field.playerComeIn("CafeteriaPoint",Vec(-2,0,2))Field.startFreeTime()end
function MC02_17_Arena()
Adv.kayamoriTalk([[More training at the arena, right?]],"VC_MC02_17_09_00_World_00000_RKayamori",nil)
Adv.kayamoriTalk([[No, it's closed for inspection today. What am I thinking?]],"VC_MC02_00800_v001_RKayamori")end