...
EventScene("MainStreet","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY06/MainStreet_General.unity")
EventScene("FriendStreet","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY06/FriendStreet_General.unity")
EventScene("Dormitory1F","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY06/Dormitory1F_General.unity")
EventScene("Grave","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY06/Grave_General.unity")
EventScene("ClockTowerRoof","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY06/ClockTowerRoof_General.unity")
...
InitScript("Lua/Story/Common/Patrol/MC02/Patrol_MC02_01")
LinneEvent("MAsami",[[Kayamori, are you free?]],MAsamiMessage,nil,"MAsami")GayaTalkFromMaster()GeneralTalkFromMaster()
...
Linne.Receive(bClTIa,[[Another patrol mission, huh?]])Linne.Inputing(bClTIa)Linne.Wait(bClTIa,1.0)
Linne.Receive(bClTIa,[[We're low on soldiers, as usual, and could use the help.]])Linne.Inputing(bClTIa)Linne.Wait(bClTIa,1.5)
Linne.Receive(bClTIa,[[If you have the time, we'd really appreciate it. You will be pleasantly rewarded.]])Wait(1.0)
