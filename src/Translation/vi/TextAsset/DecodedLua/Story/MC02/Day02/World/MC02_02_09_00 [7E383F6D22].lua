...
EventScene("MainStreet","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY02_03/MainStreet_General.unity")
EventScene("FriendStreet","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY02_03/FriendStreet_General.unity")
EventScene("Dormitory1F","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY02_03/Dormitory1F_General.unity")
EventScene("School1F","Assets/Lua/Story/Common/FieldPlacement/GeneralTalkCharacter/MC02/DAY02_03/School1F_General.unity")
...
EventScene("BackStreet","Assets/Lua/Story/Common/FieldPlacement/QuestCharacter/MC02/BackStreet_Quest.unity")end;function init()
Log("現在のフィールド："..FieldLabel())refresh()end
function refresh()
...
LinneEvent("MSatsuki",[[New boosters, in stock now! ♪]],MSatsukiMessage,nil,"Shop")local nsgji=GetWorldEventStep(w0qyLbH)if nsgji==0 then
StartEvent(function()
...
Linne.Receive(bClTIa,[[They are a little more expensive this time... ♪]])Linne.Inputing(bClTIa)Linne.Wait(bClTIa,1.0)
Linne.Receive(bClTIa,[[But as always, you get what you pay for! ♪]])Linne.Wait(bClTIa,0.5)Linne.Inputing(bClTIa)
