...
Tutorial.setMessage([[You can adjust the controls from the mePad's Options menu.]])Tutorial.show()
...
Tutorial.setMessage([[Try checking which keys are available for use here.]])Tutorial.show()Tutorial.hideMask()
